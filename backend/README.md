...
- `consulta_paciente.py`: Blueprint ativo que implementa `/api/consulta-paciente`. Veja [backend/consulta_paciente.py](backend/consulta_paciente.py#L1-L400).
...
- `paciente_routes.py`: mantem helpers antigos para compatibilidade, sem rota ativa registrada pela aplicacao.
- `agenda.py`, `agenda_api.py`: modulos adicionais registrados como Blueprints para funcionalidades de agenda.
