    ...
    function showHistoricoModal(codcli, nomecli, consultas, patient) {
        ...
        form.onsubmit = async function (event) {
            ...
            try {
                ...
                if (controller) await controller.reload();
                var updatedPatient = controller && controller.find(codcli);
    ...
    function showExamModal(patient) {
        ...
        function showForm(exam) {
            ...
            if (exam) {
                ...
                if (exam.tem_imagem) imageEmpty.textContent = 'Documento atual anexado';
            }
