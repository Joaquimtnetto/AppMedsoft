...
// Vincula evento ao formulário imediatamente ao carregar o script
setTimeout(function() {
    ...
    form.onsubmit = async function(event) {
        ...
        try {
            ...
            const nome_medico = localStorage.getItem('nome_medico') || '';
            const response = await fetch('/api/consulta-paciente', {
                ...
                body: JSON.stringify({ termo, nome_medico })
            });
            if (!response.ok) {
