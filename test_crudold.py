...
class AuthenticationGuardTest(unittest.TestCase):
    ...
    def test_menu_rejects_old_or_partial_session(self):
        with self.client.session_transaction() as flask_session:
            ...
            flask_session['session_boot_id'] = 'sessao-antiga'

        response = self.client.get('/menu.html')

        self.assertEqual(response.status_code, 302)
        with self.client.session_transaction() as flask_session:
            self.assertNotIn('usuario', flask_session)
    ...
    def test_menu_accepts_legacy_codclin_session_and_hydrates_company(self):
        with self.client.session_transaction() as flask_session:
            ...
            flask_session['db_path'] = 'medsoft_medmigra'
            flask_session['authenticated'] = True
            flask_session['session_boot_id'] = medsoft_app.SESSION_BOOT_ID
...
class AgendaCrudApiTest(unittest.TestCase):
    ...
    def test_builds_simplified_whatsapp_web_url(self):
        appointment = {
        ...
        url = agenda_api._simplified_whatsapp_url('(21) 99999-9999', appointment)
        self.assertIn('web.whatsapp.com/send?phone=5521999999999&text=', url)
        self.assertIn('Jo%C3%A3o', url)
